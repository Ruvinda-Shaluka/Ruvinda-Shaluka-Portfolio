        ...
        <div className="px-5 md:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Image src="/logo.svg" alt="Logo" width={42} height={42} className="drop-shadow-[0_0_8px_rgba(255,94,0,0.3)]" />
            </motion.button>
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <button
                    ...
                    className={`relative px-4 lg:px-6 py-5 text-[11px] md:text-xs font-bold tracking-[0.15em] transition-all duration-300 ${
            ...
            <div className="md:hidden flex items-center">
              <button
                ...
                className="p-2 rounded-lg text-[#94a3b8] hover:text-white transition-colors"
