...
const projects = [
  {
    ...
    number: '01',
    title: 'GeoBrief Live',
    tag: 'Real-Time Location-Based News SaaS',
    description:
      'A dynamic location-aware platform that aggregates, geolocates, and delivers local news based on real-time user coordinates. Features include collaborative neighborhood reporting, interactive maps, and real-time push notifications.',
    stack: ['Next.js', 'Node.js', 'MongoDB', 'Socket.io', 'Leaflet', 'TailwindCSS'],
    githubFrontendUrl: 'https://github.com/Ruvinda-Shaluka/GeoBrief-Live-Frontend.git',
    githubBackendUrl: 'https://github.com/Ruvinda-Shaluka/GeoBrief-Live-Backend.git',
    liveUrl: 'https://geobrief-live.vercel.app/',
  ...
  },
  {
    ...
    number: '02',
    title: 'Examsy',
    tag: 'Secure Online Assessment Management System',
    description:
      'A robust online examination system designed for educational institutions. Offers secure role-based access, randomized question generation, time-controlled tests, and detailed performance dashboards for both educators and students.',
    stack: ['Spring Boot', 'Java', 'React.js', 'MySQL', 'TailwindCSS'],
    githubFrontendUrl: 'https://github.com/Ruvinda-Shaluka/Examsy-Frontend.git',
    githubBackendUrl: 'https://github.com/Ruvinda-Shaluka/Examsy-Backend.git',
    liveUrl: '#',
